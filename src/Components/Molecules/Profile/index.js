...
export default function Profile() {
  ...
  return (
    <div className="profile-section">
          ...
          <div className="profileHeading">
            <div className="profileHeadingData">
              <button
                className={
                  !selectedOptionOne
                    ? `profileHeadingButton`
                    : `profileHeadingButtonSelected`
                }
                onClick={() => {
        ...
        <div className="profileContent">
          {selectedOptionOne && (
            <NameAndProfilePicView
              setShowEditPersonalDetails={setShowEditPersonalDetails}
              setShowMiniBio={setShowMiniBio}
      ...
      <EditPersonalDetails
        show={showEditPersonalDetails}
        setShow={setShowEditPersonalDetails}
      />
